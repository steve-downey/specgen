...
// declaration's markup belongs at the definition. `\omit` is the author
// asking for silence, and an unannotated entity was never documented at
// all — those stay quiet.
